        ...
        <div className="container py-4">
          <div className="row g-2 align-items-center">
            <div className="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
              ...
              Innovex Pharmaceuticals: Advancing Healthcare through Innovation and Excellence
              </h3>
              <div className="paragraph_container ">
                <p className="paragraph fs-5 pt-2">
                Innovex Pharmaceuticals stands as a beacon of innovation and excellence in the 
                realm of healthcare. With a steadfast commitment to advancing medical science 
                and improving patient outcomes, Innovex spearheads groundbreaking research and development 
          ...
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/free-photo/assorted-pharmaceutical-capsules-syringes-with-serums_114579-22168.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
            <div
              className="col-lg-6 wow fadeIn"
              ...
              <div className="content_container">
                ...
                >
                  <li className="list-group-item" data-aos="fade-left">
                    ...
                    Innovex Pharmaceuticals pioneers innovative healthcare solutions.
                  </li>
                  <li className="list-group-item" data-aos="fade-left">
          ...
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h3 className="mb-4" data-aos="fade-right">
                By partnering with Innovex Pharmaceuticals, you can:
              </h3>
              <div className="content_container">
                <ul
                  className="list-group"
              ...
              >
                ...
                Contact Innovex Pharmaceuticals today to explore our innovative healthcare solutions.
          ...
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="aboutsimg">
                <img className="img-fluid" src="https://img.freepik.com/premium-photo/healthcare-medicine-concept-background-medication-pills-blisters-vaccine-black-background_708636-644.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              <div className="content_container">
                ...
                >
                  <li className="list-group-item" data-aos="fade-left">
                    <b> Global Impact: </b> Innovex Pharmaceuticals strives to make a meaningful impact on a global scale by improving access to healthcare and advancing medical science.
                  </li>
                  <li className="list-group-item" data-aos="fade-left">
                  ...
                  <li className="list-group-item" data-aos="fade-left">
                    <b>Community Engagement: </b> Committed to giving back to the community, Innovex Pharmaceuticals actively participates in philanthropic initiatives and supports healthcare initiatives in underserved regions.
                  </li>
      ...
      <div className="container-fluid py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/free-photo/packaged-pills-basket-with-defocused-backdrop-pharmacy-shelves_91128-3457.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container-fluid section2 py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            >
              <div className="abouts">
                <img className="img-fluid" src="https://img.freepik.com/premium-photo/stomach-disease-doctor-holding-anatomy-model-study-diagnosis-treatment-hospital_39768-10374.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
