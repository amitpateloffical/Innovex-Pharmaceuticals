          ...
          <div className="row g-5 align-items-center">
            <div className="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
              <div className="abouts" data-aos="fade-right" >
                <img className="img-fluid" src="https://img.freepik.com/free-psd/modern-interior-science-laboratory-generative-ai_587448-1846.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
            <div className="col-lg-7 wow fadeIn" data-wow-delay="0.5s">
              <h4 className="mb-4 " data-aos="fade-left"> Innovex Pharmaceuticals' Trailblazing R&D</h4>
              ...
              {/* </div> */}
              <div className="containt-data fs-5">Innovex Pharmaceuticals is dedicated to shaping the future of medicine through innovative research and development. Our team of experts is committed to discovering and developing cutting-edge treatments that will improve the lives of millions. We're relentless in our pursuit of groundbreaking therapies that address unmet medical needs. Join us as we push the boundaries of what's possible and redefine the standards of car</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid py-5">
        <div className="container" style={{background:"#AFEEEE",paddingLeft:"20px", paddingTop:"30px", paddingBottom:"30px", borderLeft:"4px solid green"}}>
          <div className="row align-items-center g-5">
            ...
            Innovex Pharmaceuticals is a beacon of hope in healthcare, committed to pushing the boundaries of innovation. Our R&D division is pioneering groundbreaking treatments that transform lives. Rooted in compassion and fueled by scientific curiosity, we're rewriting the rules of medicine. Join us in our quest to revolutionize healthcare and create a brighter, healthier future for all
            </div>
            <div className="col-lg-3 wow fadeIn" data-wow-delay="0.1s">
            <div className="h-75 w-75 " data-aos="fade-right" >
                <img className="img-fluid  rounded" src="https://img.freepik.com/free-psd/modern-interior-science-laboratory-generative-ai_587448-1846.jpg?size=626&ext=jpg&ga=GA1.1.1884802103.1674757283&semt=sph" />
              </div>
            </div>
          </div>
        </div>
